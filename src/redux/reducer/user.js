...
const user = (state = initialState, action) => {
  switch (action.type) {
    ...
    case "GET_ROOMS_BY_USER_ID_PENDING": // prosesnya sedang berjalan
      return {
        ...state,
        isLoading: true,
        isError: false,
    ...
    case "GET_ROOMS_BY_USER_ID_FULFILLED": // ketika sukses
      return {
        ...state,
        isLoading: false,
        isError: false,
    ...
    case "GET_ROOMS_BY_USER_ID_REJECTED": // ketika gagal
      return {
        ...state,
        isLoading: false,
        isError: true,
    ...
    case "GET_CONTACTS_DATA_ONLY_PENDING": // prosesnya sedang berjalan
      return {
        ...state,
        isLoading: true,
        isError: false,
    ...
    case "GET_CONTACTS_DATA_ONLY_FULFILLED": // ketika sukses
      return {
        ...state,
        isLoading: false,
        isError: false,
    ...
    case "GET_CONTACTS_DATA_ONLY_REJECTED": // ketika gagal
      return {
        ...state,
        isLoading: false,
        isError: true,
    ...
    case "GET_KEYWORDS_PENDING": // prosesnya sedang berjalan
      return {
        ...state,
        isLoading: true,
        isError: false,
    ...
    case "GET_KEYWORDS_FULFILLED": // ketika sukses
      return {
        ...state,
        isLoading: false,
        isError: false,
    ...
    case "GET_KEYWORDS_REJECTED": // ketika gagal
      return {
        ...state,
        isLoading: false,
        isError: true,
    ...
    case "SEND_INVITATION_PENDING": // prosesnya sedang berjalan
      return {
        ...state,
        isLoading: true,
        isError: false,
    ...
    case "SEND_INVITATION_FULFILLED": // ketika sukses
      return {
        ...state,
        isLoading: false,
        isError: false,
    ...
    case "SEND_INVITATION_REJECTED": // ketika gagal
      return {
        ...state,
        isLoading: false,
        isError: true,
    ...
    case "GET_FRIEND_REQUEST_FULFILLED": // ketika sukses
      return {
        ...state,
        isLoading: false,
        isError: false,
